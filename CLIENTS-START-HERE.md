...
If you answered "yes" or "I don't know" to any of these → **this toolkit fixes it**.
...
Completes purchase   →   Transaction ID, revenue, tax (NO DUPLICATES)
```
...
A: Primary expertise:
- ✅ Shopify & Shopify Plus (including Custom Pixel API)
- ✅ WooCommerce (PHP hooks + GTM integration)  
...
- **Historical data import**: No (Google doesn't allow UA → GA4 import)
...
- ✅ Work async via detailed documentation + Loom videos
- ✅ Schedule calls 8am-12pm EST / 5pm-9pm CET (overlap window)
- ✅ Provide daily written updates so you're never blocked
- ✅ Use Slack for quick questions (<2 hour response during work hours)
...
👉 **[View WooCommerce implementation](ecommerce-platforms/woocommerce-tracking.php)**  
👉 **[See Shopify Liquid template](ecommerce-platforms/shopify-complete-tracking.liquid)**  
👉 **[Watch 5-min video walkthrough]** [Insert YouTube link - create in Phase 2]
...
**Clinical trials → eCommerce analytics parallels**:
- FDA data validation rules → GA4 event QA checklists  
- Trial data deduplication → Purchase event deduplication
- Protocol documentation → Implementation SOPs
- Adverse event tracking → Error monitoring
...
**For developers evaluating code quality** → [See main README.md](README.md)

**For businesses evaluating service** → You're in the right place! 👆 Scroll up to [pricing section](#pricing--timeline)
